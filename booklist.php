...
require('includes/config.php');
 session_start();
	...
	$totalq="select count(*) \"total\" from products where p_subcat='$cat'";
									...
									<div class="entry">
										...
										<table border="4" width="100%" >
											...
											<?php
												...
												$query="select * from products where p_subcat='$cat' LIMIT ".$k .",".$page_per_page;
												...
												while($row=mysqli_fetch_assoc($res))
												{
													...
													echo '<td valign="top" width="20%" align="center">
														<a href="detail.php?id='.$row['p_id'].'&cat='.$_GET['subcatnm'].'">
														<img src="'.$row['p_img'].'" width="80" height="100">
														<br>'.$row['p_name'].'</a>
													</td>';
													$count++;							
