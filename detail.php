			...
			<!-- start page -->
				...
				<div id="page">
						<!-- start content -->
							<div id="content">
								<div class="post">
									<h1 class="title"><?php echo $row['p_name'];?></h1>
									<div class="entry">
										<?php
											...
											<table border="0"  width="100%" bgcolor="#ffffff">
													...
													<td width="50%" height="100%">
														<table border="0"  width="100%" height="100%">
															...
															<tr>
																...
																<td>: </td>
																<td align="left">'.$row['p_retailer'].'</td>
												...
												<tr valign="bottom" >
														...
														<a href="'.$row['p_img'].'" rel="lightbox"><img src="images/zoom.gif" ></a>
											...
											<table border="0" width="100%">
												 ...
												 {
													echo ' <td><a href="process_cart.php?nm='.$row['p_name'].'&cat='.$_GET['cat'].'&rate='.$row['p_price'].'">
