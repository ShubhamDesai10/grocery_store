		...
		<div class="post">
			...
			<div class="entry">
					...
					<table border='1' WIDTH='100%'>
						<tr>
						<td colspan="7"><a href="addbook.php">Add New Product</a></td>
						</tr>
						<tr>
							<td WIDTH='10%' style="color:darkgreen"><b><u>SR.NO</u></b></td>
							<TD style="color:darkgreen" WIDTH='50%'><b><u>NAME</u></b></TD>
							<TD style="color:darkgreen" WIDTH='20%'><b><u>RETAILER</u></b></TD>
						...
						<?php
							...
							echo '<tr>
										...
										<td>'.$row['p_desc'].'
										<td>'.$row['p_price'];
									echo "<td><img src='../$row[p_img]' width='50'/>";
										
										
									echo 	'<td><a href="process_del_book.php?sid='.$row['p_id'].'"><img src="images/drop.png" ></a>
